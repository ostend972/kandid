...
import { CircleCheck, BarChart3, Briefcase, FileText, Shield } from "lucide-react";
...
const Feature = () => {
  const features = [
    ...
    { label: "Niveaux CECR", active: true },
    { label: "Score ATS", active: false },
    { label: "CV 2 pages", active: false },
    { label: "Lettre de motivation", active: false },
    { label: "References", active: false },
    { label: "Dossier PDF", active: false },
    { label: "20 000+ offres", active: false },
  ];
                    ...
                    <CardContent className="flex flex-col gap-4 sm:gap-8 px-10">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-sm sm:text-lg font-normal text-muted-foreground">
                          Notre IA evalue votre profil selon les criteres du marche suisse : photo, diplomes, terminologie, langues CECR.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <motion.div variants={itemVariants} className="h-full">
                  <Card className="py-10 h-full shadow-xs">
                    <CardContent className="flex flex-col gap-4 sm:gap-8 px-10">
                      ...
                      <div className="flex flex-col gap-2">
                        <p className="text-xl font-semibold">Trouvez les bonnes offres</p>
                        <p className="text-sm sm:text-lg font-normal text-muted-foreground">
                          Plus de 20 000 offres en Suisse romande, filtrees par canton, contrat et secteur. Score de compatibilite IA.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <motion.div variants={itemVariants}>
                <Card className="p-0 gap-0 shadow-xs overflow-hidden">
                  ...
                  <CardContent className="flex flex-col gap-4 sm:gap-8 px-10 py-8 border-t border-border">
                    ...
                    <div className="flex flex-col gap-2">
                      <p className="text-xl font-semibold">Postulez avec un dossier complet</p>
                      <p className="text-sm sm:text-lg font-normal text-muted-foreground">
                        CV suisse 2 pages, lettre de motivation, references — assembles en un dossier PDF professionnel.
                      </p>
                    </div>
                  </CardContent>
                </Card>
